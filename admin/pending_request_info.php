  ...
  <div class="modal-box w-11/12 max-w-3xl">
    ...
    <div>
       ...
       <div class="flex items-center gap-2 mb-4">
        ...
        <?php 
            $file_extension = strtolower(pathinfo($docs['doc_name'], PATHINFO_EXTENSION)); 
        ?>
            ...
            <div class="mb-4">
                <?php if (in_array($file_extension, ['jpg', 'jpeg', 'png', 'webp'])): ?>
                    <a href="./../assets/uploads/<?php echo $images['image_name']; ?>" target="_blank">
                        <img src="./../assets/uploads/<?php echo $images['image_name']; ?>" class="w-[100%] lg:w-[100%] lg:min-h-50 rounded-[20px] p-3 cursor-pointer hover:opacity-90 transition" alt="Document Image">
                    </a>
                <?php else: ?>
