  ...
  ?>
    ...
    <div class="drawer lg:drawer-open ">
        ...
        <nav class="navbar w-full bg-base-300 px-4 bg-[#0fab9e]">
            ...
            <div class="flex-1 font-bold text-white">Verified Requests</div>
        </nav>
        <div class="py-6">
            <!--main content-->
            <main>
                                            ...
                                            while($row = mysqli_fetch_assoc($result_request)){
                                             ...
                                             echo '
                                                <tr class="data-row">
                                                    ...
                                                    <td>
                                                        <a href="pending_request_info.php?id=' . $landlord_id . '&location_back=verified_properties.php" class="btn btn-success text-white">More Info</a>
                                                    </td>
                                                </tr>';
