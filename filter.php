    ...
    <Section class="my-container py-[100px]">
      ...
      <?php
        $get_rental = $conn->prepare("
            SELECT r.*, l.province, l.municipality, l.barangay, l.property_name,r.price,r.type,r.rate
            FROM rentspace r
        ...
        if ($result_rental->num_rows > 0) {
            ...
            echo '
                <div class="col-span-full flex flex-col items-center justify-center py-16 text-white">
                  ...
                  <p class="text-xs text-white mt-1">New listings will appear here once added.</p>
                </div>
            ';
        }
      ?>
