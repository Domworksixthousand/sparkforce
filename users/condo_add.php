  ...
  <div class="bg-white rounded-2xl shadow-2xl border border-slate-100 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden transform transition-all">
    ...
    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70 sticky top-0 z-10 backdrop-blur-md">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-lg font-bold text-slate-800">Condominium Configuration</h2>
          <p class="text-xs text-slate-500">Manage condo unit details, pricing, photos, unit specs, and amenities.</p>
        </div>
      </div>
    ...
    <form action="../functions.php" method="POST" enctype="multipart/form-data" class="p-6 overflow-y-auto space-y-8" id="mainForm">
        ...
        <!-- ============================================ -->
        <!-- SECTION 1: CONDOMINIUM INFORMATION -->
        <!-- ============================================ -->
        <div class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input type="text"
                               ...
                               name="cs_name"
                               value="<?php echo htmlspecialchars($_SESSION['cs_name'] ?? ''); ?>"
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input type="text"
                               ...
                               name="cs_price"
                               value="<?php echo htmlspecialchars($_SESSION['cs_price'] ?? ''); ?>"
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative flex items-center">
                        <input type="text"
                               ...
                               name="cs_rate"
                               value="<?php echo htmlspecialchars($_SESSION['cs_rate'] ?? ''); ?>"
            ...
            <div class="space-y-1.5 pt-2" id="cover-section">
                ...
                <?php if (!empty($_SESSION['cs_cover'])): ?>
                    ...
                    <div class="flex items-center justify-between bg-emerald-50/60 border border-emerald-100 p-2.5 rounded-xl text-xs mb-2">
                        <div class="flex items-center gap-3">
                            <img src="../assets/uploads/<?php echo htmlspecialchars($_SESSION['cs_cover']); ?>"
                                 class="w-10 h-10 object-cover rounded-lg border border-white shadow-xs"
                                 alt="Preview">
                            <span class="text-emerald-900">Previously selected:
                                <strong class="underline font-medium"><?php echo htmlspecialchars($_SESSION['cs_cover']); ?></strong>
                            </span>
                        </div>
            ...
            <div class="space-y-1.5 pt-2">
                ...
                <div class="border border-slate-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-500 transition-all">
                    <textarea
                        id="myEditor"
                        name="cs_other_info"><?php echo htmlspecialchars($_SESSION['cs_other_info'] ?? ''); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="pt-4 border-t border-slate-100 flex items-center justify-end gap-3 sticky bottom-0 bg-white py-3 -mx-6 px-6">
            ...
            <button type="submit" name="save_condo"
...
tinymce.init({
    ...
    // json_encode used instead of addslashes()+template literal — addslashes doesn't
    // escape backticks or ${...}, so saved content containing either could break out
    // of a JS template literal and either throw or inject unintended script.
    init_instance_callback: function (editor) {
        const content = <?php echo json_encode($_SESSION['cs_other_info'] ?? ''); ?>;
        if (content) {
