    ...
    <form action="../functions.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="w-[100%] flex flex-col  gap-3 mb-5">
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    ...
                    <input type="text" class="autoInput grow w-[100%]" name="house_name" value="<?php echo $_SESSION['house_name'] ?? ''; ?>" placeholder="Enter Name / Number" required />
                </label>
            </span>
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    ...
                    <input type="text" class="numbers_only grow w-[100%]" name="house_price"  value="<?php echo htmlspecialchars($_SESSION['house_price'] ?? ''); ?>" placeholder="Enter Price /Month" required />
                </label>
            </span>
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5 text-gray-500"><path d="M20 11H4"/><path d="M20 7H4"/><path d="M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7"/></svg>
                    <input type="text" class="autoInput grow w-[100%]" name="house_rate"  value="<?php echo $_SESSION['house_rate'] ?? ''; ?>" placeholder="Enter Rate" required />
                </label>
            </span>
            <span class="w-[100%]">
                ...
                <?php if (!empty($_SESSION['house_cover'])): ?>
                    ...
                    <div class="alert alert-success bg-success/10 text-success border border-success/20 p-2 mb-2 text-xs flex items-center justify-between rounded-lg">
                        <div class="flex items-center gap-2">
                            <img src="../assets/uploads/<?php echo htmlspecialchars($_SESSION['house_cover']); ?>" class="w-10 h-10 object-cover rounded" alt="Preview">
                            <span>Previously selected: <strong class="underline"><?php echo htmlspecialchars($_SESSION['house_cover']); ?></strong></span>
                        </div>
        ...
        <div class="mb-5">        
           ...
           <div class="w-[100%] mb-3">
            ...
            <div class="w-[100%] mb-3">
                ...
                <label class="input w-[100%]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-parking-icon lucide-circle-parking"><circle cx="12" cy="12" r="10"/><path d="M9 17V7h4a3 3 0 0 1 0 6H9"/></svg>
      ...
      <div id="amenities-container1">
        ...
        <div class="text-end mt-4">
            <button type="submit" name="save_house" class="btn btn-success text-white">Save</button>
        </div>
    </form>
  </div>
</dialog>
