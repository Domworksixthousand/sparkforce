    ...
    <form action="../functions.php" method="POST" enctype="multipart/form-data">
       ...
       <?php if (!empty($boarding_houses)): ?>
        ...
        <?php endif; ?>
         ...
         <div class="mb-3">
            <button type="button" id="addamenBtn" class="btn btn-success text-white btn-sm">
                ...
                $selectedAmenities = (!empty($_SESSION['amenities']) && is_array($_SESSION['amenities'])) 
                    ? $_SESSION['amenities'] 
                    : [""];
                ?> 
        ...
        <div class="text-end mt-4">
            <button type="submit" name="edit_boarding" class="btn btn-success text-white">Save</button>
        </div>
    </form>
  </div>
</dialog>
