    ...
    <form action="../functions.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="w-[100%] flex flex-col  gap-3 mb-5">
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    ...
                    <input type="text" class="autoInput grow w-[100%]" name="condo_name" value="<?php echo htmlspecialchars($name ?? ''); ?>" placeholder="Enter Name / Number" required />
                </label>
            </span>
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    ...
                    <input type="text" class="numbers_only grow w-[100%]" name="condo_price"  value="<?php echo htmlspecialchars($price ?? ''); ?>" placeholder="Enter Price /Month" required />
                </label>
            </span>
            <span class="w-[100%]">
                ...
                <label class="input w-[100%]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5 text-gray-500"><path d="M20 11H4"/><path d="M20 7H4"/><path d="M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7"/></svg>
                    <input type="text" class="autoInput grow w-[100%]" name="condo_rate"  value="<?php echo $rate ?? ''; ?>" placeholder="Enter Rate" required />
                </label>
            </span>
            <span class="w-[100%]">
        ...
        <div class="w-[100%] flex flex-col lg:flex-row gap-3 mb-5">
            <span class="w-[100%]">
                ...
                <textarea class="input w-[100%] border border-gray-300 rounded-sm min-h-50 p-3" name="apartment_other_info" placeholder="Enter Other Informations" required><?php echo htmlspecialchars($other_info ?? ''); ?></textarea>
            </span>
        </div>
            ...
            <div class="w-[100%] mb-3">
                <p class="mb-2 text-sm">Square Area *</p>
                 <label class="input w-[100%]">
                    ...
                    <input type="text" class=" grow w-[100%]" name="square_area"  value="<?php echo htmlspecialchars($square_area ?? ''); ?>" placeholder="Enter Unit Square Area" required />
                </label>
            </div>     
            <div class="w-[100%] mb-3">
                ...
                <label class="input w-[100%]">
                    ...
                    <select class="select w-[100%]" name="type" required>
                        <option value="<?php echo $bedroom_type; ?>" disabled <?php echo empty($bedroom_type) ? 'selected' : ''; ?>>Select Bedroom </option>
             ...
             <div class="w-[100%] mb-3">
                ...
                <?php if (!empty($condo_images)): ?>
                    ...
                    <div class="alert alert-success bg-success/10 text-success border border-success/20 p-2 mb-2 text-xs rounded-lg">
                        <?php echo count($condo_images); ?> photo(s) retained. Upload new photos below to replace them.
                    </div>
                <?php endif; ?>
      ...
      <div id="amenities-container1">
        ...
        <div class="text-end mt-4">
            <button type="submit" name="edit_condo" class="btn btn-success text-white">Edit</button>
        </div>
    </form>
  </div>
</dialog>
