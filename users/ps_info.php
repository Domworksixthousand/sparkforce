...
// Helper for status badges (reused pattern from transient_info.php)
  ...
  <div class="modal-box w-11/12 max-w-4xl p-0 overflow-hidden">
    ...
    <div class="relative w-full h-56 sm:h-64">
      ...
      <div class="absolute top-3 left-3 flex gap-2">
        ...
        <span class="badge <?php echo psStatusBadge($status); ?> text-white border-none">
    ...
    <div class="p-5 max-h-[50vh] overflow-y-auto">
      ...
      <!-- SPACE DETAILS (single parking space record) -->
      <div class="tab-panel hidden" data-panel="details">
          ...
          <div class="card bg-base-100 border border-base-200 shadow-sm p-4">
            <div class="flex items-start justify-between mb-2">
              <div>
                <h4 class="font-bold text-base text-gray-800">
                  <?php echo htmlspecialchars($type_ps !== '' ? $type_ps : 'Standard Parking Space'); ?>
                </h4>
                <p class="text-xs text-gray-500">
                  Space ID: <?php echo htmlspecialchars($ps_id); ?>
                </p>
              </div>
              <span class="badge <?php echo psStatusBadge($status); ?> text-white">
                <?php echo htmlspecialchars($status !== '' ? $status : 'Unknown'); ?>
              </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2 mt-2 pt-2 border-t border-base-200 text-xs text-gray-600">
              ...
              <div>
                ...
                <?php echo htmlspecialchars($type_ps !== '' ? $type_ps : 'N/A'); ?>
              </div>
              <div>
        ...
        <?php else: ?>
          <p class="text-sm text-gray-500 italic">No parking space registered for this property.</p>
        <?php endif; ?>
      </div>
